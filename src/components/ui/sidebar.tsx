...
function SidebarMenuButton({
	...
	// Compose render prop with TooltipTrigger when tooltip is provided
	const composedRender = React.useMemo(() => {
		if (!tooltip) return render;
		if (!render) return TooltipTrigger;
		// When both tooltip and render are provided, wrap TooltipTrigger with the custom render element
		return (triggerProps: React.ComponentProps<"button">) => (
			<TooltipTrigger {...triggerProps} render={render} />
		);
	}, [tooltip, render]);
